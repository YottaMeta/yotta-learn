#!/usr/bin/env node
/**
 * @yottameta/yotta-learn cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-learn --agent <name>
 *   npx -y @yottameta/yotta-learn --dir <path>
 *   npx -y @yottameta/yotta-learn -g
 *   npx -y @yottameta/yotta-learn
 *   npx -y @yottameta/yotta-learn --list
 */
'use strict';
...
function usage() {
  console.log('yotta-learn installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-learn --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-learn --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-learn -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-learn                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-learn --list           List supported agent directories');
  console.log('');
  console.log('Options:');
